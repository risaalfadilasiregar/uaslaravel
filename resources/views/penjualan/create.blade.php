...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="needs-validation" novalidate action="{{ Route('penjualan.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                        ...
                        {{-- <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            ...
                            <select name="id_barang">
                                @foreach ($barang as $data)
                                    <option value="{{ $data->id_barang }}">{{ $data->harga }}</option>
                                @endforeach
                            </select>
                            <div class="valid-feedback">
                                Looks good!
                    ...
                    <div class="form-row">
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                            <button class="btn btn-warning"><a href="{{ Route('penjualan.index') }}">Kembali</a></button>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
